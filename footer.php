            ...
            <div class="footer-wrapper">
                <div class="container">
                    <div class="row">
                            ...
                            <ul class="travel-news">
                                <li>
                                    ...
                                    <div class="description">
                                        ...
                                        <p>By not going to school I learned that the world is a beautiful place and needs to be discovered.</p>
                        ...
                        <div class="col-sm-6 col-md-6">
                            <h2>About Sandesh Tours</h2>
                            <p>The people when rightly and fully trusted will return the trust.</p>
                            <br />
                            <address class="contact-details">
                                <span class="contact-phone"><i class="soap-icon-phone"></i> +91 9768 782 555</span>
                                <br />
                                <!--<a href="#" class="contact-email">--><span class="contact-email">sandeshtours@gmail.com</span><!--</a>-->
                            </address>
